...
//
//import com.wwzh.vplus.common.bean.vo.PermVo;
...
//
//    public static List<PermVo> listPermVo(List<PermissionVo> permissions) {
...
//                for (PermVo permVo : perm3.getChildren()) {
...
//                    leftPerm.setApi(api);
//                    perm3.getChildren().add(leftPerm);
//                } else {
...
//    }
//
//    public static List<PermissionVo> listPermission(ApplicationContext context, String basicPackage) {
...
//                throw new RuntimeException("目前权限管理应该在method的前面使用GetMapping注解或者PostMapping注解或者DeleteMapping注解");
//            }
//        }
//        return permissions;
//    }
//
//    public static Set<String> listPermissionString(List<PermissionVo> permissions) {
